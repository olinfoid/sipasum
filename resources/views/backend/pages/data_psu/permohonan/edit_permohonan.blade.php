...
@push('be-meta-seo')
    ...
    <meta content="Halaman Edit Permohonan PSU" name="description">
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex mb-3">
        ...
        <div class="p-2 w-100">
            <h4 class="mb-1">Edit Permohonan PSU</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style2 mb-0">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="{{ route('be.psu.permohonan.index_edit_permohonan').'/'.$id }}">Edit Permohonan</a>
                    </li>
                </ol>
            </nav>
        </div>
                                ...
                                <div class="input-group">
                                    <select id="edt-perumahan" name="perumahan" 
                                        ...
                                        @foreach($select_perumahan as $sel_perumahan)
                                            <option value="{{$sel_perumahan->id_perumahan}}" data-subtext="({{$sel_perumahan->nm_perusahaan}})" @selected($perumahan->id_perumahan == $sel_perumahan->id_perumahan)>
                                                {{strtoupper($sel_perumahan->nm_perumahan)}} 
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="edt-perusahaan_pengembang" name="perusahaan_pengembang" 
                                ...
                                @foreach($pengembang as $val_pengembang)
                                    <option value="{{$val_pengembang->id}}" @selected($perumahan->id_pengembang == $val_pengembang->id)>{{strtoupper($val_pengembang->nm_perusahaan)}}</option>
                                @endforeach
                            </select>
